...
class BaseURLs:
    ...
    class MES:
        AUTH = "https://login.mos.ru"
        SCHOOL = "https://school.mos.ru"
        SCHOOL_API = "https://school.mos.ru/api"
        DNEVNIK = "https://dnevnik.mos.ru"


def BaseURL(type: str, system: str) -> str:  # noqa: N802
